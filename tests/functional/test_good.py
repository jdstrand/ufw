...
class GoodTests(FunctionalTestCase):
    class_name = "good"
    ...
    def test_rules(self):
        ...
        self.assertIn("2222", self.read(self.user_rules))
        self.assert_ok(
            "deny",
            "out",
            "log-all",
        ...
        self.assertNotIn("2222", self.read(self.user_rules))
        ...
        self.assertLess(rules.index("6.7.8.9"), rules.index("1.2.3.4"))
